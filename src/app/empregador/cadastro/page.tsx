      ...
      <Section>
        <form className="form-card" action={registerEmployerAction}>
          <div className="form-grid">
            <label>Empresa<input name="companyName" autoComplete="organization" maxLength={120} required /></label>
            <label>Responsável<input name="contactName" autoComplete="name" maxLength={120} required /></label>
            <EmployerDocumentInput />
