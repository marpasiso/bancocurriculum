...
function subscriptionPaymentText(value: string) {
  return value ? `O Pix manual de ${formatMoney(value)} libera busca e detalhes por 7 dias.` : "O valor da assinatura e a cobrança Pix são informados pelo administrador.";
}
      ...
      <Section title="Regras de acesso">
        <div className="grid">
          ...
          <article className="card">
            ...
            <p>{subscriptionPaymentText(settings.subscriptionPaymentAmount)}</p>
          </article>
          <article className="card">
            <h2>Auditoria</h2>
