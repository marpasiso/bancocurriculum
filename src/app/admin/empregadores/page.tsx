...
import { EmployerDocumentInput } from "@/components/employer-document-input";
        ...
        <section className="panel compact-card employer-summary-panel">
          ...
          <form action={updateEmployerAction} className="mui-compact-form employer-edit-form">
            ...
            <div className="form-grid compact-form-grid">
              <label>
                Empresa
                <input name="companyName" maxLength={120} required type="text" defaultValue={editingEmployer.companyName} />
              </label>
              <label>
                Nome do contato
                <input name="contactName" maxLength={120} required type="text" defaultValue={editingEmployer.contactName} />
              </label>
                <EmployerDocumentInput defaultValue={editingEmployer.document} />
              <label>
                E-mail de login
                <input name="email" inputMode="email" maxLength={160} required type="email" defaultValue={editingEmployer.user.email} />
              </label>
            </div>
