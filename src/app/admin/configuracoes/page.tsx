          ...
          <Section title="Plataforma" description="Textos institucionais simples exibidos pela plataforma.">
            <div className="form-grid">
              <label>Nome da plataforma
                <input name="platformName" maxLength={80} required defaultValue={settings.platformName} />
              </label>
              <label className="full-span">Descrição da plataforma
                <textarea name="platformDescription" maxLength={240} required defaultValue={settings.platformDescription} />
              </label>
            </div>
          </Section>
