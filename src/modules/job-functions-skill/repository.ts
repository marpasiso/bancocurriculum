...
export async function createSystemJobFunction(input: { name: string; category?: string; description?: string }) {
...
export async function updateSystemJobFunction(input: { jobFunctionId: string; name: string; category?: string; description?: string }) {
...
export async function upsertSystemJobFunction(input: { name: string; category?: string; description?: string; isActive?: boolean }) {
